...
const MapaRefugios = lazy(() => import("./islands/MapaRefugios"));
...
const modelos = [
    {
    titulo: "Refugio Plano Modular",
    subtitulo: "Alta Capacidad Ampliable",
    descripcion:
      "Análisis visual y despiece del sistema de acoplamiento modular. Te mostramos los componentes que permiten expandir el espacio de forma limpia.",
    iconos: ["Modular", "Despiece", "Gran Capacidad"],
    color: "from-purple-500/20",
    videoUrl: "/videos/Refugio modular - Render Montaje.mp4",
    tienePlay: true,
  },
  {
    titulo: "Refugio para Salamanquesas",
    subtitulo: "Entornos Urbanos y Jardines",
    descripcion:
      "Muestra visual en primer plano de los acabados texturizados de la madera y la integración de elementos impresos en 3D que facilitan el agarre y asentamiento.",
    iconos: ["Muestra Visual", "Detalles 3D", "Madera Selecta"],
    color: "from-emerald-500/20",
    videoUrl: "/videos/Refugio salamanquesas - Render marketing - Final.mp4",
    tienePlay: true,
  },
  {
    titulo: "Refugio Fisurícolas",
    subtitulo: "Especies Forestales y de Grieta",
    descripcion:
      "Inspección estructural al descubierto del diseño de cámaras estrechas. Grabación orientada a analizar cómo simula a la perfección las fisuras naturales.",
    iconos: ["Fisuras", "Cámara Estrecha", "Aislamiento"],
    color: "from-marca-principal/20",
    videoUrl: "/videos/Refugio doble cámara - Render marketing - final.mp4",
    tienePlay: true,
  },
  {
    titulo: "Refugio Plano de Una Cámara",
    subtitulo: "Diseño Compacto y Fachadas",
    descripcion:
      "Un recorrido macro por el habitáculo de cámara única. Detalle visual de la rugosidad interna de la madera técnica diseñada para el agarre óptimo.",
    iconos: ["Cámara Única", "Compacto", "Madera Técnica"],
    color: "from-blue-500/20",
    videoUrl: "/videos/Refugio plano una cámara - TurnAround.mp4",
    tienePlay: true,
  },

  {
    titulo: "Refugio Cilíndrico",
    subtitulo: "Integración Forestal Óptima",
    descripcion:
      "Grabación detallada en 360 grados de la morfología circular de la caja, diseñada especialmente para mimetizarse con la corteza de los árboles.",
    iconos: ["Circular", "Mimetizado", "Vista 360°"],
    color: "from-amber-500/20",
    videoUrl: "/videos/Refugio cilíndrico - Marketing - Final.mp4",
    tienePlay: true,
  },
  {
    titulo: "Refugio Triangular",
    subtitulo: "Estructuras Angulares y Aleros",
    descripcion:
      "Revisión técnica de la geometría en cuña del refugio. Muestra del comportamiento aerodinámico y de la cámara trasera contra la humedad.",
    iconos: ["Triangular", "Construcción", "Esquinas"],
    color: "from-cyan-500/20",
    videoUrl: "/videos/Refugio triangular - Render marketing - Final.mp4",
    tienePlay: true,
  },
  {
    titulo: "Refugio Cavernícolas",
    subtitulo: "Simulación de Grutas y Cuevas",
    descripcion:
      "Estudio visual con lente macro de los materiales internos encargados de replicar la oscuridad absoluta y el microclima térmico de una cueva.",
    iconos: ["Macro", "Térmico", "Especies de Cueva"],
    color: "from-zinc-500/20",
    videoUrl: "/videos/Refugio cavernícola - Marketing - Final.mp4",
    tienePlay: true,
  },
];
      ...
      <section className="relative w-full h-[85vh] min-h-[600px] flex items-center justify-center overflow-hidden bg-black border-b border-white/5">
        ...
        <div className="absolute inset-0 z-0 bg-[#050505]">
          {<video
            ...
            src="/videos/Refugio modular - Render Montaje.mp4"
          >
        ...
        <div className="relative z-30 max-w-4xl mx-auto px-6 text-center">
          <motion.span className="inline-block px-4 py-1.5 mb-6 rounded-full border border-marca-principal/30 bg-marca-principal/10 text-marca-principal text-[10px] font-bold uppercase tracking-[0.3em]">
            Control Biológico Natural
          </motion.span>
          <motion.h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight tracking-tight">
            Protege el entorno. <br />
            <span className="text-marca-principal">Rescata la fauna.</span>
          </motion.h1>
          <motion.p className="text-lg md:text-xl text-white mb-10 max-w-2xl mx-auto leading-relaxed font-light">
      ...
      <section className="py-24 px-6 bg-white text-black overflow-hidden relative">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="flex-1 order-1 md:order-2 w-full">
            <div className="relative rounded-[2rem] overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.15)] bg-black aspect-[4/5] border border-gray-100">
              {/* El video */}
              <video
                src="/videos/Refugio - V.Final - Vista Explotada 3.mp4"
                autoPlay
                muted
                loop
                playsInline
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative order-1 lg:order-2">
              <AnimatePresence mode="wait">
                ...
                >
                  <iframe
                    src={modelos[indiceActivo].videoUrl}
                    title={modelos[indiceActivo].titulo}
