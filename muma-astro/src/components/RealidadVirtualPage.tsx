...
const ALIANZAS = [
  ...
  { nombre: 'ST3ER', logo: '/images/st3er.png' },
...
export default function RealidadVirtualPage() {
  ...
  {/* Cambiado flex-row por flex-wrap para que no se salga del div si no hay espacio */}
  <div className="flex flex-wrap items-center gap-4 w-full">
    
    {/* Contenedor 1 — SECEMU */}
    <div className="bg-black backdrop-blur-sm rounded-lg px-5 py-3 flex items-center justify-center border border-white/10 shadow-sm shrink-0">
      <img src="/images/Logo_SECEMU_blanco.webp" alt="SECEMU" className="h-28 w-auto object-contain opacity-90" />
    </div>
    
    {/* Contenedor 2 — EUROBATS */}
    <div className="bg-black backdrop-blur-sm rounded-lg px-5 py-3 flex items-center justify-center border border-white/10 shadow-sm shrink-0">
      <img src="/images/EUROBATS_logo.webp" alt="EUROBATS" className="h-28 w-auto object-contain opacity-90" />
    </div>
    
    {/* Contenedor 3 — Unión Europea (Ancho y protegido dentro del flujo) */}
    <div className="bg-black backdrop-blur-sm rounded-lg px-8 py-3 flex items-center justify-center border border-white/10 shadow-sm shrink-0 min-w-[180px] max-w-full">
      <img src="/images/europa.webp" alt="Unión Europea FEDER" className="h-28 w-auto object-contain opacity-90" />
    </div>
            ...
            <div className="flex flex-col gap-3 lg:gap-4 w-full relative h-fit sticky top-32">
              ...
              >
                ...
                <video
                  ...
                  poster="\images\MUMA LOGO VECTOR-05_resultado.webp"
  ...
  className="mt-16 rounded-2xl bg-white/5 px-8 py-12" // Subido el padding vertical a py-12
>
  <p className="text-xs font-bold tracking-[0.2em] text-marca-principal uppercase mb-10 text-center">
    Proyecto financiado por
  </p>
  
  {/* Aumentado el gap-6 a gap-10 para que al ser más grandes no se peguen */}
  <div className="flex flex-wrap items-center justify-center gap-10">
    {[
      ...
      <div key={i} className="px-6 py-4 flex items-center justify-center">
        <img
          src={logo.src}
          alt={logo.alt}
          // Cambiado h-12 por h-20 (80px) y añadido max-w-xs para logos muy anchos
          className="h-24 max-w-[240px] w-auto object-contain transition-all duration-300 opacity-80 hover:opacity-100 dynamic-logo"
          loading="lazy"
        />
      </div>
    ))}
